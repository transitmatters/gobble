...
def test_localized_datetime():
    ...
    assert service_date(datetime(2023, 12, 15, 0, 0, 0, tzinfo=EASTERN_TIME)) == date(2023, 12, 14)
    assert service_date(datetime(2023, 12, 15, 2, 59, 59, tzinfo=EASTERN_TIME)) == date(2023, 12, 14)
